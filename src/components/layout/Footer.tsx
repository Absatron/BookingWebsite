          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                  <svg className="h-5 w-5 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="https://www.instagram.com/kalucuts" target="_blank" rel="noopener noreferrer" className="text-booking-accent hover:text-white transition-colors">
                    <span className="text-gray-300">kalucuts</span>
                 </a>
              </li>
            </ul>
          </div>
