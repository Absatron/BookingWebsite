    ...
    <footer className="bg-booking-primary text-white pt-12 pb-8">
      <div className="booking-container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-booking-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <MapPin className="h-5 w-5 text-booking-accent shrink-0 mt-0.5" />
                <span className="text-gray-300">123 Booking Street, Suite 101<br />San Francisco, CA 94107</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-5 w-5 text-booking-accent shrink-0" />
                <span className="text-gray-300">(123) 456-7890</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-5 w-5 text-booking-accent shrink-0" />
                <span className="text-gray-300">contact@bookmaster.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} BookMaster. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
